...
- 🛒 **Marellshop.ru & Telegram-бот** — коммерческая разработка интернет-магазина и сопровождающего Telegram-бота под ключ. Построение архитектуры, работа с БД, успешный вывод проекта в продакшен и активная поддержка.
